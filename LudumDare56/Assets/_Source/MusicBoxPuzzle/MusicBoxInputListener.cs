    ...
    public class MusicBoxInputListener : AInputListener
    {
        ...
        void Update()
        {
            if (_input)
            {
                ...
                {
                    _musicBoxController.Check(_musicBoxData.Slider, _musicBoxData.BgSlider);
                    _musicBoxController.GeneratePoint(_musicBoxData.BgSlider);
                }
            }
        }
        ...
        public void CompleteTutor()
        {
            ...
            if (isFixed)
            {
                ...
                _handle.DOLocalRotate(new Vector3(0, 180, 0), 1).SetLoops(-1, LoopType.Incremental);
        ...
        public override void TurnInput()
        {
            ...
            base.TurnInput();
            _input = false;
            if (_handlePlace.transform.childCount > 0)
                isFixed = true;
        }
    }
}